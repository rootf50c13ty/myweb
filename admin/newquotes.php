...
table.a {
  ...
  <body>
    ...
    <div class="topnav">
      ...
      <a class="active" href="newquotes.php">New Quotes</a>
...
<?php
          ...
          {    
              ...
              $query="select * from quotes where status=0";
              $rr=$con->query($query);
              ...
              if(mysqli_num_rows($rr)>0)
              {
                ...
                {
                          echo "<center><font color=red>We dont have new quotes..</font></center>";
